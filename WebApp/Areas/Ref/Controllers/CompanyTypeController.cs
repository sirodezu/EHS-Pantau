...
namespace WebApp.Areas.Ref.Controllers
{
    ...
    public class CompanyTypeController : Controller
    {
        ...
        private string _path_controler = "/Ref/CompanyType/";
        private string _path_view = "/Areas/Ref/Views/CompanyType/";
        private readonly string _table_name = "ref_comptype";
        private readonly string _table_title = "Company Type";

		private static IHostingEnvironment _hostingEnvironment;
        public CompanyTypeController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(CompanyTypeModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = CompanyTypeModel._pkKey;
                    ViewData["displayItem"] = CompanyTypeModel.GetDisplayItem();
                    ViewData["column_att"] = CompanyTypeModel.GetGridColumn();
                    ViewData["param"] = CompanyTypeModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(CompanyTypeModel.ActionRequest param)
        {
            GridData data = CompanyTypeModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    CompanyTypeModel.ViewModel fieldModel = new CompanyTypeModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = CompanyTypeModel.GetViewData(PkValue);
                        if (data != null)
                        {
        ...
        [HttpGet]
        public IActionResult Add(CompanyTypeModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //CompanyTypeModel.ViewModel fieldModel = new CompanyTypeModel.ViewModel();
                    fieldModel.id = CompanyTypeModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = CompanyTypeModel.GetViewData(PkValue);
                    CompanyTypeModel.ViewModel fieldModel = new CompanyTypeModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = CompanyTypeModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(CompanyTypeModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = CompanyTypeModel.GetNewId().ToString();
                    ...
                    result = CompanyTypeModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(CompanyTypeModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(CompanyTypeModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(CompanyTypeModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = CompanyTypeModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = CompanyTypeModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = CompanyTypeModel.LookupData(param);
            return Json(data);
        }
