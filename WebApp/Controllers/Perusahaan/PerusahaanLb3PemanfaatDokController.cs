...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PemanfaatDokController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3PemanfaatDok/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3PemanfaatDok/";
        private readonly string _table_name = "ref_lb3_pemanfaat_dokumen";
        private readonly string _table_title = "Dokumen Pemanfaat Limbah B3 ";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PemanfaatDokController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PemanfaatDokModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PemanfaatDokModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PemanfaatDokModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PemanfaatDokModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PemanfaatDokModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PemanfaatDokModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PemanfaatDokModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatDokModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = PerusahaanLb3PemanfaatDokModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.pemanfaat_id = dr["pemanfaat_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatDokModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PemanfaatDokModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PemanfaatDokModel.GetViewData(PkValue);
                    PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatDokModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PemanfaatDokModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PemanfaatDokModel.GetNewId().ToString();
                    data["pemanfaat_id"] = fieldModel.pemanfaat_id;
                    ...
                    result = PerusahaanLb3PemanfaatDokModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PemanfaatDokModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PemanfaatDokModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PemanfaatDokModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PemanfaatDokModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PemanfaatDokModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PemanfaatDokModel.LookupData(param);
            return Json(data);
        }
