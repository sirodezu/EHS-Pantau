...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PengangkutController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3Pengangkut/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3Pengangkut/";
        private readonly string _table_name = "ref_lb3_pengangkut";
        private readonly string _table_title = "Perusahaan Pengangkut Limbah LB3";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PengangkutController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PengangkutModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PengangkutModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PengangkutModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PengangkutModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PengangkutModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PengangkutModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PengangkutModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PengangkutModel.ViewModel fieldModel = new PerusahaanLb3PengangkutModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = PerusahaanLb3PengangkutModel.GetViewData(PkValue);
                        if (data != null)
                        {
                    ...
                    ViewData["fieldModel"] = fieldModel;
                    ViewData["pengangkut_id"] = fieldModel.id;
                    ViewData["AllowView"] = SecurityHelper.HasRule(HttpContext, _rule_view) ? "1" : "0";
                    ViewData["AllowAdd"] = SecurityHelper.HasRule(HttpContext, _rule_add) ? "1" : "0";
                    ViewData["AllowEdit"] = SecurityHelper.HasRule(HttpContext, _rule_edit) ? "1" : "0";
                    ViewData["AllowDelete"] = SecurityHelper.HasRule(HttpContext, _rule_delete) ? "1" : "0";
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PengangkutModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PengangkutModel.ViewModel fieldModel = new PerusahaanLb3PengangkutModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PengangkutModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PengangkutModel.GetViewData(PkValue);
                    PerusahaanLb3PengangkutModel.ViewModel fieldModel = new PerusahaanLb3PengangkutModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PengangkutModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PengangkutModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PengangkutModel.GetNewId().ToString();
                    ...
                    result = PerusahaanLb3PengangkutModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PengangkutModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PengangkutModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PengangkutModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PengangkutModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PengangkutModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PengangkutModel.LookupData(param);
            return Json(data);
        }
