...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PenimbunDokController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3PenimbunDok/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3PenimbunDok/";
        private readonly string _table_name = "ref_lb3_penimbun_dokumen";
        private readonly string _table_title = "Dokumen Penimbun Limbah B3 ";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PenimbunDokController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PenimbunDokModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PenimbunDokModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PenimbunDokModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PenimbunDokModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PenimbunDokModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PenimbunDokModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PenimbunDokModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PenimbunDokModel.ViewModel fieldModel = new PerusahaanLb3PenimbunDokModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = PerusahaanLb3PenimbunDokModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.penimbun_id = dr["penimbun_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PenimbunDokModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PenimbunDokModel.ViewModel fieldModel = new PerusahaanLb3PenimbunDokModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PenimbunDokModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PenimbunDokModel.GetViewData(PkValue);
                    PerusahaanLb3PenimbunDokModel.ViewModel fieldModel = new PerusahaanLb3PenimbunDokModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PenimbunDokModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PenimbunDokModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PenimbunDokModel.GetNewId().ToString();
                    data["penimbun_id"] = fieldModel.penimbun_id;
                    ...
                    result = PerusahaanLb3PenimbunDokModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PenimbunDokModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PenimbunDokModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PenimbunDokModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PenimbunDokModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PenimbunDokModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PenimbunDokModel.LookupData(param);
            return Json(data);
        }
