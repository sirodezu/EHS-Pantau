...
namespace WebApp.Controllers
{
    ...
    public class FasSpekIplcLayoutController : Controller
    {
        ...
        private string _path_controler = "/FasSpekIplcLayout/";
        private string _path_view = "/Views/Fasilitas/FasSpekIplcLayout/";
        private readonly string _table_name = "ta_fas_spek_iplc_layout";
        private readonly string _table_title = "Fas Spek Iplc Layout";

		private static IHostingEnvironment _hostingEnvironment;
        public FasSpekIplcLayoutController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(FasSpekIplcLayoutModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = FasSpekIplcLayoutModel._pkKey;
                    ViewData["displayItem"] = FasSpekIplcLayoutModel.GetDisplayItem();
                    ViewData["column_att"] = FasSpekIplcLayoutModel.GetGridColumn();
                    ViewData["param"] = FasSpekIplcLayoutModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(FasSpekIplcLayoutModel.ActionRequest param)
        {
            GridData data = FasSpekIplcLayoutModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    FasSpekIplcLayoutModel.ViewModel fieldModel = new FasSpekIplcLayoutModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = FasSpekIplcLayoutModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.spek_iplc_id = dr["spek_iplc_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(FasSpekIplcLayoutModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //FasSpekIplcLayoutModel.ViewModel fieldModel = new FasSpekIplcLayoutModel.ViewModel();
                    fieldModel.id = FasSpekIplcLayoutModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = FasSpekIplcLayoutModel.GetViewData(PkValue);
                    FasSpekIplcLayoutModel.ViewModel fieldModel = new FasSpekIplcLayoutModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = FasSpekIplcLayoutModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(FasSpekIplcLayoutModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = FasSpekIplcLayoutModel.GetNewId().ToString();
                    data["spek_iplc_id"] = fieldModel.spek_iplc_id;
                    ...
                    result = FasSpekIplcLayoutModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(FasSpekIplcLayoutModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(FasSpekIplcLayoutModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(FasSpekIplcLayoutModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = FasSpekIplcLayoutModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = FasSpekIplcLayoutModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = FasSpekIplcLayoutModel.LookupData(param);
            return Json(data);
        }
