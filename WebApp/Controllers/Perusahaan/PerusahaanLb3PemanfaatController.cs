...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PemanfaatController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3Pemanfaat/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3Pemanfaat/";
        private readonly string _table_name = "ref_lb3_pemanfaat";
        private readonly string _table_title = "Perusahaan Pemanfaat Limbah B3";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PemanfaatController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PemanfaatModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PemanfaatModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PemanfaatModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PemanfaatModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PemanfaatModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PemanfaatModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PemanfaatModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PemanfaatModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = PerusahaanLb3PemanfaatModel.GetViewData(PkValue);
                        if (data != null)
                        {
                    ...
                    ViewData["fieldModel"] = fieldModel;
                    ViewData["pemanfaat_id"] = fieldModel.id;
                    ViewData["AllowView"] = SecurityHelper.HasRule(HttpContext, _rule_view) ? "1" : "0";
                    ViewData["AllowAdd"] = SecurityHelper.HasRule(HttpContext, _rule_add) ? "1" : "0";
                    ViewData["AllowEdit"] = SecurityHelper.HasRule(HttpContext, _rule_edit) ? "1" : "0";
                    ViewData["AllowDelete"] = SecurityHelper.HasRule(HttpContext, _rule_delete) ? "1" : "0";
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PemanfaatModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PemanfaatModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PemanfaatModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PemanfaatModel.GetViewData(PkValue);
                    PerusahaanLb3PemanfaatModel.ViewModel fieldModel = new PerusahaanLb3PemanfaatModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PemanfaatModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PemanfaatModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PemanfaatModel.GetNewId().ToString();
                    ...
                    result = PerusahaanLb3PemanfaatModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PemanfaatModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PemanfaatModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PemanfaatModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PemanfaatModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PemanfaatModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PemanfaatModel.LookupData(param);
            return Json(data);
        }
