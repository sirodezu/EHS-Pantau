...
namespace WebApp.Controllers
{
    ...
    public class FasSpekIpalDomestikController : Controller
    {
        ...
        private string _path_controler = "/FasSpekIpalDomestik/";
        private string _path_view = "/Views/Fasilitas/FasSpekIpalDomestik/";
        private readonly string _table_name = "ta_fas_spek_ipal_domestik";
        private readonly string _table_title = "Fas Spek Ipal Domestik";

		private static IHostingEnvironment _hostingEnvironment;
        public FasSpekIpalDomestikController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(FasSpekIpalDomestikModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = FasSpekIpalDomestikModel._pkKey;
                    ViewData["displayItem"] = FasSpekIpalDomestikModel.GetDisplayItem();
                    ViewData["column_att"] = FasSpekIpalDomestikModel.GetGridColumn();
                    ViewData["param"] = FasSpekIpalDomestikModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(FasSpekIpalDomestikModel.ActionRequest param)
        {
            GridData data = FasSpekIpalDomestikModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    FasSpekIpalDomestikModel.ViewModel fieldModel = new FasSpekIpalDomestikModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = FasSpekIpalDomestikModel.GetViewData(PkValue);
                        if (data != null)
                        {
        ...
        [HttpGet]
        public IActionResult Add(FasSpekIpalDomestikModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //FasSpekIpalDomestikModel.ViewModel fieldModel = new FasSpekIpalDomestikModel.ViewModel();
                    fieldModel.id = FasSpekIpalDomestikModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = FasSpekIpalDomestikModel.GetViewData(PkValue);
                    FasSpekIpalDomestikModel.ViewModel fieldModel = new FasSpekIpalDomestikModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = FasSpekIpalDomestikModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(FasSpekIpalDomestikModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = FasSpekIpalDomestikModel.GetNewId().ToString();
                    ...
                    result = FasSpekIpalDomestikModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(FasSpekIpalDomestikModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(FasSpekIpalDomestikModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(FasSpekIpalDomestikModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = FasSpekIpalDomestikModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = FasSpekIpalDomestikModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = FasSpekIpalDomestikModel.LookupData(param);
            return Json(data);
        }
