...
namespace WebApp.Areas.Ref.Controllers
{
    ...
    public class CompanyController : Controller
    {
        ...
        private string _path_controler = "/Ref/Company/";
        private string _path_view = "/Areas/Ref/Views/Company/";
        private readonly string _table_name = "ref_company";
        private readonly string _table_title = "Company";
		...
		[HttpGet]
        public IActionResult Index(CompanyModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = CompanyModel._pkKey;
                    ViewData["displayItem"] = CompanyModel.GetDisplayItem();
                    ViewData["column_att"] = CompanyModel.GetGridColumn();
                    ViewData["param"] = CompanyModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(CompanyModel.ActionRequest param)
        {
            GridData data = CompanyModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    CompanyModel.ViewModel fieldModel = new CompanyModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = CompanyModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.comtype_id = dr["comtype_id"].ToString();
                                fieldModel.comtype_id_text = dr["comtype_id_text"].ToString();
                                fieldModel.comtype_nama = dr["comtype_nama"].ToString();
                                fieldModel.comcat_id = dr["comcat_id"].ToString();
                                fieldModel.comcat_id_text = dr["comcat_id_text"].ToString();
                                fieldModel.comcat_nama = dr["comcat_nama"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(CompanyModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //CompanyModel.ViewModel fieldModel = new CompanyModel.ViewModel();
                    fieldModel.id = CompanyModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = CompanyModel.GetViewData(PkValue);
                    CompanyModel.ViewModel fieldModel = new CompanyModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = CompanyModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(CompanyModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = CompanyModel.GetNewId().ToString();
                    ...
                    data["comtype_id"] = fieldModel.comtype_id;
                    data["comtype_nama"] = AntiXss.HtmlEncode(fieldModel.comtype_nama);
                    data["comcat_id"] = fieldModel.comcat_id;
                    data["comcat_nama"] = AntiXss.HtmlEncode(fieldModel.comcat_nama);
                    ...
                    result = CompanyModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(CompanyModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(CompanyModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(CompanyModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = CompanyModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = CompanyModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = CompanyModel.LookupData(param);
            return Json(data);
        }
