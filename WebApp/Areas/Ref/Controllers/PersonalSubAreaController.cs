...
namespace WebApp.Areas.Ref.Controllers
{
    ...
    [Area("Ref")]
    public class PersonalSubAreaController : Controller
    {
        ...
        private string _path_controler = "/Ref/PersonalSubArea/";
        private string _path_view = "/Areas/Ref/Views/PersonalSubArea/";
        private readonly string _table_name = "ref_personal_sub_area";
        private readonly string _table_title = "Personal Sub Area";

		private static IHostingEnvironment _hostingEnvironment;
        public PersonalSubAreaController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PersonalSubAreaModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PersonalSubAreaModel._pkKey;
                    ViewData["displayItem"] = PersonalSubAreaModel.GetDisplayItem();
                    ViewData["column_att"] = PersonalSubAreaModel.GetGridColumn();
                    ViewData["param"] = PersonalSubAreaModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PersonalSubAreaModel.ActionRequest param)
        {
            GridData data = PersonalSubAreaModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PersonalSubAreaModel.ViewModel fieldModel = new PersonalSubAreaModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = PersonalSubAreaModel.GetViewData(PkValue);
                        if (data != null)
                        {
                    ...
                    ViewData["fieldModel"] = fieldModel;
                    ViewData["HeadData"] = PersonalSubAreaModel.GetHeadData(id);
        ...
        [HttpGet]
        public IActionResult Add(PersonalSubAreaModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PersonalSubAreaModel.ViewModel fieldModel = new PersonalSubAreaModel.ViewModel();
                    fieldModel.id = PersonalSubAreaModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PersonalSubAreaModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PersonalSubAreaModel.GetNewId().ToString();
                    ...
                    result = PersonalSubAreaModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PersonalSubAreaModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PersonalSubAreaModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(PersonalSubAreaModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PersonalSubAreaModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PersonalSubAreaModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PersonalSubAreaModel.LookupData(param);
            return Json(data);
        }

        [HttpPost]
        public JsonResult LookupDataPSA(lookup_param param)
        {
            DataTable data = PersonalSubAreaModel.LookupDataPSA(HttpContext, param);
            return Json(data);
        }
