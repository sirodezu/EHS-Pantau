...
namespace WebApp.Controllers
{
    ...
    public class FasSpekSteadyCraneController : Controller
    {
        ...
        private string _path_controler = "/FasSpekSteadyCrane/";
        private string _path_view = "/Views/Fasilitas/FasSpekSteadyCrane/";
        private readonly string _table_name = "ta_fas_spek_steady_crane";
        private readonly string _table_title = "Fas Spek Steady Crane";

		private static IHostingEnvironment _hostingEnvironment;
        public FasSpekSteadyCraneController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(FasSpekSteadyCraneModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = FasSpekSteadyCraneModel._pkKey;
                    ViewData["displayItem"] = FasSpekSteadyCraneModel.GetDisplayItem();
                    ViewData["column_att"] = FasSpekSteadyCraneModel.GetGridColumn();
                    ViewData["param"] = FasSpekSteadyCraneModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(FasSpekSteadyCraneModel.ActionRequest param)
        {
            GridData data = FasSpekSteadyCraneModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    FasSpekSteadyCraneModel.ViewModel fieldModel = new FasSpekSteadyCraneModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = FasSpekSteadyCraneModel.GetViewData(PkValue);
                        if (data != null)
                        {
        ...
        [HttpGet]
        public IActionResult Add(FasSpekSteadyCraneModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //FasSpekSteadyCraneModel.ViewModel fieldModel = new FasSpekSteadyCraneModel.ViewModel();
                    fieldModel.id = FasSpekSteadyCraneModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = FasSpekSteadyCraneModel.GetViewData(PkValue);
                    FasSpekSteadyCraneModel.ViewModel fieldModel = new FasSpekSteadyCraneModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = FasSpekSteadyCraneModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(FasSpekSteadyCraneModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = FasSpekSteadyCraneModel.GetNewId().ToString();
                    ...
                    result = FasSpekSteadyCraneModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(FasSpekSteadyCraneModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(FasSpekSteadyCraneModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(FasSpekSteadyCraneModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = FasSpekSteadyCraneModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = FasSpekSteadyCraneModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = FasSpekSteadyCraneModel.LookupData(param);
            return Json(data);
        }
