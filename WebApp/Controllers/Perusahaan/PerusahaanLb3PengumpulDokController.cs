...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PengumpulDokController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3PengumpulDok/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3PengumpulDok/";
        private readonly string _table_name = "ref_lb3_pengumpul_dokumen";
        private readonly string _table_title = "Perusahaan Pengumpul LB3 Dok";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PengumpulDokController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PengumpulDokModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PengumpulDokModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PengumpulDokModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PengumpulDokModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PengumpulDokModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PengumpulDokModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PengumpulDokModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PengumpulDokModel.ViewModel fieldModel = new PerusahaanLb3PengumpulDokModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = PerusahaanLb3PengumpulDokModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.pengumpul_id = dr["pengumpul_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PengumpulDokModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PengumpulDokModel.ViewModel fieldModel = new PerusahaanLb3PengumpulDokModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PengumpulDokModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PengumpulDokModel.GetViewData(PkValue);
                    PerusahaanLb3PengumpulDokModel.ViewModel fieldModel = new PerusahaanLb3PengumpulDokModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PengumpulDokModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PengumpulDokModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PengumpulDokModel.GetNewId().ToString();
                    data["pengumpul_id"] = fieldModel.pengumpul_id;
                    ...
                    result = PerusahaanLb3PengumpulDokModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PengumpulDokModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PengumpulDokModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PengumpulDokModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PengumpulDokModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PengumpulDokModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PengumpulDokModel.LookupData(param);
            return Json(data);
        }
