...
namespace WebApp.Areas.Ref.Controllers
{
    ...
    [Area("Ref")]
    public class Lb3UsahaController : Controller
    {
        ...
        private string _path_controler = "/Ref/Lb3Usaha/";
        private string _path_view = "/Areas/Ref/Views/Lb3Usaha/";
        private readonly string _table_name = "ref_lb3_usaha";
        private readonly string _table_title = "Usaha LB3";

		private static IHostingEnvironment _hostingEnvironment;
        public Lb3UsahaController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(Lb3UsahaModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = Lb3UsahaModel._pkKey;
                    ViewData["displayItem"] = Lb3UsahaModel.GetDisplayItem();
                    ViewData["column_att"] = Lb3UsahaModel.GetGridColumn();
                    ViewData["param"] = Lb3UsahaModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(Lb3UsahaModel.ActionRequest param)
        {
            GridData data = Lb3UsahaModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    Lb3UsahaModel.ViewModel fieldModel = new Lb3UsahaModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = Lb3UsahaModel.GetViewData(PkValue);
                        if (data != null)
                        {
        ...
        [HttpGet]
        public IActionResult Add(Lb3UsahaModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //Lb3UsahaModel.ViewModel fieldModel = new Lb3UsahaModel.ViewModel();
                    fieldModel.id = Lb3UsahaModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = Lb3UsahaModel.GetViewData(PkValue);
                    Lb3UsahaModel.ViewModel fieldModel = new Lb3UsahaModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = Lb3UsahaModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(Lb3UsahaModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = Lb3UsahaModel.GetNewId().ToString();
                    ...
                    result = Lb3UsahaModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(Lb3UsahaModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(Lb3UsahaModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(Lb3UsahaModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = Lb3UsahaModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = Lb3UsahaModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = Lb3UsahaModel.LookupData(param);
            return Json(data);
        }        
