...
namespace WebApp.Controllers
{
    ...
    public class AuditKriteriaAgcTmController : Controller
    {
        ...
        private string _path_controler = "/AuditKriteriaAgcTm/";
        private string _path_view = "/Views/Audit/AuditKriteriaAgcTm/";
        private readonly string _table_name = "ta_audit_kriteria_agc_tm";
        private readonly string _table_title = "Kriteria Audit";

		private static IHostingEnvironment _hostingEnvironment;
        public AuditKriteriaAgcTmController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(AuditKriteriaAgcTmModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = AuditKriteriaAgcTmModel._pkKey;
                    ViewData["displayItem"] = AuditKriteriaAgcTmModel.GetDisplayItem();
                    ViewData["column_att"] = AuditKriteriaAgcTmModel.GetGridColumn();
                    ViewData["param"] = AuditKriteriaAgcTmModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(AuditKriteriaAgcTmModel.ActionRequest param)
        {
            GridData data = AuditKriteriaAgcTmModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    AuditKriteriaAgcTmModel.ViewModel fieldModel = new AuditKriteriaAgcTmModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = AuditKriteriaAgcTmModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.land_clearing_id = dr["land_clearing_id"].ToString();
                                fieldModel.land_clearing_id_text = dr["land_clearing_id_text"].ToString();
                                fieldModel.rusak_lahan_id = dr["rusak_lahan_id"].ToString();
                                fieldModel.rusak_lahan_id_text = dr["rusak_lahan_id_text"].ToString();
                                fieldModel.efisiensi_energi_id = dr["efisiensi_energi_id"].ToString();
                                fieldModel.efisiensi_energi_id_text = dr["efisiensi_energi_id_text"].ToString();
                                fieldModel.manfaat_lb3_id = dr["manfaat_lb3_id"].ToString();
                                fieldModel.manfaat_lb3_id_text = dr["manfaat_lb3_id_text"].ToString();
                                fieldModel.kelola_non_lb3_id = dr["kelola_non_lb3_id"].ToString();
                                fieldModel.kelola_non_lb3_id_text = dr["kelola_non_lb3_id_text"].ToString();
                                fieldModel.kurang_cemar_udara_id = dr["kurang_cemar_udara_id"].ToString();
                                fieldModel.kurang_cemar_udara_id_text = dr["kurang_cemar_udara_id_text"].ToString();
                                fieldModel.konservasi_air_id = dr["konservasi_air_id"].ToString();
                                fieldModel.konservasi_air_id_text = dr["konservasi_air_id_text"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(AuditKriteriaAgcTmModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //AuditKriteriaAgcTmModel.ViewModel fieldModel = new AuditKriteriaAgcTmModel.ViewModel();
                    fieldModel.id = AuditKriteriaAgcTmModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = AuditKriteriaAgcTmModel.GetViewData(PkValue);
                    AuditKriteriaAgcTmModel.ViewModel fieldModel = new AuditKriteriaAgcTmModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = AuditKriteriaAgcTmModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(AuditKriteriaAgcTmModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = AuditKriteriaAgcTmModel.GetNewId().ToString();
                    ...
                    data["land_clearing_id"] = fieldModel.land_clearing_id;
                    data["rusak_lahan_id"] = fieldModel.rusak_lahan_id;
                    data["efisiensi_energi_id"] = fieldModel.efisiensi_energi_id;
                    data["manfaat_lb3_id"] = fieldModel.manfaat_lb3_id;
                    data["kelola_non_lb3_id"] = fieldModel.kelola_non_lb3_id;
                    data["kurang_cemar_udara_id"] = fieldModel.kurang_cemar_udara_id;
                    data["konservasi_air_id"] = fieldModel.konservasi_air_id;
                    ...
                    result = AuditKriteriaAgcTmModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(AuditKriteriaAgcTmModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(AuditKriteriaAgcTmModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(AuditKriteriaAgcTmModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = AuditKriteriaAgcTmModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = AuditKriteriaAgcTmModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = AuditKriteriaAgcTmModel.LookupData(param);
            return Json(data);
        }
        ...
        {
            data["status_akhir_acp_id"] = AuditKriteriaAgcTmModel.GetStatusAkhirACP(
                data["strategy"].ToString(),
                data["process"].ToString(),
                data["product"].ToString(),
                data["employee"].ToString()
            );
            data["status_akhir_cpproper_id"] = AuditKriteriaAgcTmModel.GetStatusAkhirCPProper(
                data["amdal_id"].ToString(),
                data["pencemaran_air_id"].ToString(),
                data["pencemaran_udara_id"].ToString(),
                data["limbah_lb3_id"].ToString(),
                data["land_clearing_id"].ToString(),
                data["rusak_lahan_id"].ToString(),
                data["efisiensi_energi_id"].ToString(),
                data["manfaat_lb3_id"].ToString(),
                data["kelola_non_lb3_id"].ToString(),
                data["kurang_cemar_udara_id"].ToString(),
                data["konservasi_air_id"].ToString(),
                data["comdev_id"].ToString()
            );
            data["status_akhir_incident_rate_id"] = AuditKriteriaAgcTmModel.GetStatusAkhirIncidentRate(
                data["audit_id"].ToString(),
                data["fr_tk"].ToString(),
                data["sr_tf"].ToString()
            );
            data["status_akhir_cpsafety_id"] = AuditKriteriaAgcTmModel.GetStatusAkhirCPSafety(
            ...
            data["status_akhir_agc_id"] = AuditKriteriaAgcTmModel.GetStatusAkhirAGC(
