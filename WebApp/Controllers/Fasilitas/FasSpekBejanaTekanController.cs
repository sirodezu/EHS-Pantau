...
namespace WebApp.Controllers
{
    ...
    public class FasSpekBejanaTekanController : Controller
    {
        ...
        private string _path_controler = "/FasSpekBejanaTekan/";
        private string _path_view = "/Views/Fasilitas/FasSpekBejanaTekan/";
        private readonly string _table_name = "ta_fas_spek_bejana_tekan";
        private readonly string _table_title = "Fas Spek Bejana Tekan";

		private static IHostingEnvironment _hostingEnvironment;
        public FasSpekBejanaTekanController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(FasSpekBejanaTekanModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = FasSpekBejanaTekanModel._pkKey;
                    ViewData["displayItem"] = FasSpekBejanaTekanModel.GetDisplayItem();
                    ViewData["column_att"] = FasSpekBejanaTekanModel.GetGridColumn();
                    ViewData["param"] = FasSpekBejanaTekanModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(FasSpekBejanaTekanModel.ActionRequest param)
        {
            GridData data = FasSpekBejanaTekanModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    FasSpekBejanaTekanModel.ViewModel fieldModel = new FasSpekBejanaTekanModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = FasSpekBejanaTekanModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.jenis_bejana_tekan_id = dr["jenis_bejana_tekan_id"].ToString();
                                fieldModel.jenis_bejana_tekan_id_text = dr["jenis_bejana_tekan_id_text"].ToString();
                                fieldModel.bahan_gas_diisikan = dr["bahan_gas_diisikan"].ToString();
                                fieldModel.bentuk_bejana_tekan_id = dr["bentuk_bejana_tekan_id"].ToString();
                                fieldModel.bentuk_bejana_tekan_id_text = dr["bentuk_bejana_tekan_id_text"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(FasSpekBejanaTekanModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //FasSpekBejanaTekanModel.ViewModel fieldModel = new FasSpekBejanaTekanModel.ViewModel();
                    fieldModel.id = FasSpekBejanaTekanModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = FasSpekBejanaTekanModel.GetViewData(PkValue);
                    FasSpekBejanaTekanModel.ViewModel fieldModel = new FasSpekBejanaTekanModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = FasSpekBejanaTekanModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(FasSpekBejanaTekanModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = FasSpekBejanaTekanModel.GetNewId().ToString();
                    ...
                    data["jenis_bejana_tekan_id"] = fieldModel.jenis_bejana_tekan_id;
                    data["bahan_gas_diisikan"] = AntiXss.HtmlEncode(fieldModel.bahan_gas_diisikan);
                    data["bentuk_bejana_tekan_id"] = fieldModel.bentuk_bejana_tekan_id;
                    ...
                    result = FasSpekBejanaTekanModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(FasSpekBejanaTekanModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(FasSpekBejanaTekanModel.GetData(PkValue));
                    ...
                    OrderedDictionary data = DataModel.DtToDictionary(FasSpekBejanaTekanModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = FasSpekBejanaTekanModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = FasSpekBejanaTekanModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = FasSpekBejanaTekanModel.LookupData(param);
            return Json(data);
        }
