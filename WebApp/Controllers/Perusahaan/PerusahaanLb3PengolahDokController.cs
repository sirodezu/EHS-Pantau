...
namespace WebApp.Controllers
{
    ...
    public class PerusahaanLb3PengolahDokController : Controller
    {
        ...
        private string _path_controler = "/PerusahaanLb3PengolahDok/";
        private string _path_view = "/Views/Perusahaan/PerusahaanLb3PengolahDok/";
        private readonly string _table_name = "ref_lb3_pengolah_dokumen";
        private readonly string _table_title = "Dokumen Pengolah Limbah B3 ";

		private static IHostingEnvironment _hostingEnvironment;
        public PerusahaanLb3PengolahDokController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(PerusahaanLb3PengolahDokModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = PerusahaanLb3PengolahDokModel._pkKey;
                    ViewData["displayItem"] = PerusahaanLb3PengolahDokModel.GetDisplayItem();
                    ViewData["column_att"] = PerusahaanLb3PengolahDokModel.GetGridColumn();
                    ViewData["param"] = PerusahaanLb3PengolahDokModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(PerusahaanLb3PengolahDokModel.ActionRequest param)
        {
            GridData data = PerusahaanLb3PengolahDokModel.GetListData(param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    PerusahaanLb3PengolahDokModel.ViewModel fieldModel = new PerusahaanLb3PengolahDokModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = PerusahaanLb3PengolahDokModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.pengolah_id = dr["pengolah_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(PerusahaanLb3PengolahDokModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //PerusahaanLb3PengolahDokModel.ViewModel fieldModel = new PerusahaanLb3PengolahDokModel.ViewModel();
                    fieldModel.id = PerusahaanLb3PengolahDokModel.GetNewId().ToString();
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = PerusahaanLb3PengolahDokModel.GetViewData(PkValue);
                    PerusahaanLb3PengolahDokModel.ViewModel fieldModel = new PerusahaanLb3PengolahDokModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = PerusahaanLb3PengolahDokModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(PerusahaanLb3PengolahDokModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = PerusahaanLb3PengolahDokModel.GetNewId().ToString();
                    data["pengolah_id"] = fieldModel.pengolah_id;
                    ...
                    result = PerusahaanLb3PengolahDokModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(PerusahaanLb3PengolahDokModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(PerusahaanLb3PengolahDokModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(PerusahaanLb3PengolahDokModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = PerusahaanLb3PengolahDokModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = PerusahaanLb3PengolahDokModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = PerusahaanLb3PengolahDokModel.LookupData(param);
            return Json(data);
        }
