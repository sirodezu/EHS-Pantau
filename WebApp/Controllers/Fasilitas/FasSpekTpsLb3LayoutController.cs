...
namespace WebApp.Controllers
{
    ...
    public class FasSpekTpsLb3LayoutController : Controller
    {
        ...
        private string _path_controler = "/FasSpekTpsLb3Layout/";
        private string _path_view = "/Views/Fasilitas/FasSpekTpsLb3Layout/";
        private readonly string _table_name = "ta_fas_spek_tps_lb3_layout";
        private readonly string _table_title = "Fas Spek Tps Lb3 Layout";

		private static IHostingEnvironment _hostingEnvironment;
        public FasSpekTpsLb3LayoutController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(FasSpekTpsLb3LayoutModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = FasSpekTpsLb3LayoutModel._pkKey;
                    ViewData["displayItem"] = FasSpekTpsLb3LayoutModel.GetDisplayItem();
                    ViewData["column_att"] = FasSpekTpsLb3LayoutModel.GetGridColumn();
                    ViewData["param"] = FasSpekTpsLb3LayoutModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(FasSpekTpsLb3LayoutModel.ActionRequest param)
        {
            GridData data = FasSpekTpsLb3LayoutModel.GetListData(param);
            return Json(data);
        }
        [HttpGet]
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    FasSpekTpsLb3LayoutModel.ViewModel fieldModel = new FasSpekTpsLb3LayoutModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        ...
                        PkValue["id"] = id;
                        data = FasSpekTpsLb3LayoutModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.spek_tps_lb3_id = dr["spek_tps_lb3_id"].ToString();
        ...
        [HttpGet]
        public IActionResult Add(FasSpekTpsLb3LayoutModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //FasSpekTpsLb3LayoutModel.ViewModel fieldModel = new FasSpekTpsLb3LayoutModel.ViewModel();
                    fieldModel.id = FasSpekTpsLb3LayoutModel.GetNewId().ToString();
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = FasSpekTpsLb3LayoutModel.GetViewData(PkValue);
                    FasSpekTpsLb3LayoutModel.ViewModel fieldModel = new FasSpekTpsLb3LayoutModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = FasSpekTpsLb3LayoutModel.GetNewId().ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(FasSpekTpsLb3LayoutModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = FasSpekTpsLb3LayoutModel.GetNewId().ToString();
                    data["spek_tps_lb3_id"] = fieldModel.spek_tps_lb3_id;
                    ...
                    result = FasSpekTpsLb3LayoutModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(FasSpekTpsLb3LayoutModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(FasSpekTpsLb3LayoutModel.GetData(PkValue));

                    OrderedDictionary data = DataModel.DtToDictionary(FasSpekTpsLb3LayoutModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = FasSpekTpsLb3LayoutModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = FasSpekTpsLb3LayoutModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = FasSpekTpsLb3LayoutModel.LookupData(param);
            return Json(data);
        }
