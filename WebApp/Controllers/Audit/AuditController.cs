...
namespace WebApp.Controllers
{
    ...
    public class AuditController : Controller
    {
        ...
        private string _path_controler = "/Audit/";
        private string _path_view = "/Views/Audit/Audit/";
        private readonly string _table_name = "ta_audit";
        private readonly string _table_title = "Audit";

		private static IHostingEnvironment _hostingEnvironment;
        public AuditController(IHostingEnvironment hostingEnvironment)
        {
            _hostingEnvironment = hostingEnvironment;
        }

		[HttpGet]
        public IActionResult Index(AuditModel.ViewModel filterColumn)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["pkKey"] = AuditModel._pkKey;
                    ViewData["displayItem"] = AuditModel.GetDisplayItem();
                    ViewData["column_att"] = AuditModel.GetGridColumn();
                    ViewData["param"] = AuditModel.GetListParam();
        ...
        [HttpPost]
        public JsonResult GetListData(AuditModel.ActionRequest param)
        {
            GridData data = AuditModel.GetListData(HttpContext, param);
            string baseUrl = WebHelper.GetBaseUrl(HttpContext);
            for (int i=0; i<data.data.Rows.Count; i++) {
                var PkValue = new OrderedDictionary();
                PkValue["id"] = data.data.Rows[i]["id"];
                data.data.Rows[i]["audit_file_path"] = FileHelper.GetlinkDownload(baseUrl, _table_name, PkValue, "audit_file_path", data.data.Rows[i]["audit_file_path"].ToString());
            }
        ...
        public IActionResult ViewItem(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_view))
                {
                    ...
                    ViewData["Title"] = ViewData["TitleHeader"];
                    AuditModel.ViewModel fieldModel = new AuditModel.ViewModel();
                    ...
                    if (id != null && id !="" )
                    {
                        var PkValue = new OrderedDictionary();
                        PkValue["id"] = id;
                        data = AuditModel.GetViewData(PkValue);
                        if (data != null)
                        {
                            foreach (DataRow dr in data.Rows)
                            {
                                ...
                                fieldModel.tgl_audit = dr["tgl_audit"].ToString() != "" ? String.Format("{0:dd/MM/yyyy}", dr["tgl_audit"]) : "";
                                fieldModel.pelaksana_audit_id = dr["pelaksana_audit_id"].ToString();
                                fieldModel.pelaksana_audit_id_text = dr["pelaksana_audit_id_text"].ToString();
                                fieldModel.audit_file_path = FileHelper.GetlinkDownload(baseUrl, _table_name, PkValue, "audit_file_path", dr["audit_file_path"].ToString());
                                fieldModel.nama_auditor = dr["nama_auditor"].ToString();
                                fieldModel.jenis_audit_id = dr["jenis_audit_id"].ToString();
                                fieldModel.jenis_audit_id_text = dr["jenis_audit_id_text"].ToString();
                                fieldModel.masa_berlaku = dr["masa_berlaku"].ToString() != "" ? String.Format("{0:dd/MM/yyyy}", dr["masa_berlaku"]) : "";
                                fieldModel.badan_pemberi_sertifikat = dr["badan_pemberi_sertifikat"].ToString();
                    ...
                    ViewData["fieldModel"] = fieldModel;
                    ViewData["audit_id"] = fieldModel.id;
                    ViewData["AllowView"] = SecurityHelper.HasRule(HttpContext, _rule_view) ? "1" : "0";
                    ViewData["AllowAdd"] = SecurityHelper.HasRule(HttpContext, _rule_add) ? "1" : "0";
                    ViewData["AllowEdit"] = SecurityHelper.HasRule(HttpContext, _rule_edit) ? "1" : "0";
                    ViewData["AllowDelete"] = SecurityHelper.HasRule(HttpContext, _rule_delete) ? "1" : "0";
        ...
        [HttpGet]
        public IActionResult Add(AuditModel.ViewModel fieldModel)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    //AuditModel.ViewModel fieldModel = new AuditModel.ViewModel();
                    fieldModel.id = AuditModel.GetNewId().ToString();
                    fieldModel.audit_file_path_init = "[]";
                    ViewData["fieldModel"] = fieldModel;
        ...
        public IActionResult Copy(string id)
        {
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id;
                    DataTable data = AuditModel.GetViewData(PkValue);
                    AuditModel.ViewModel fieldModel = new AuditModel.ViewModel();
                    foreach (DataRow dr in data.Rows)
                    {
                        fieldModel.id = AuditModel.GetNewId().ToString();
                        ...
                        fieldModel.pa_id = dr["pa_id"].ToString();
                        fieldModel.psa_id = dr["psa_id"].ToString();
                        fieldModel.tgl_audit = dr["tgl_audit"].ToString();
                        fieldModel.pelaksana_audit_id = dr["pelaksana_audit_id"].ToString();
                        fieldModel.audit_file_path = dr["audit_file_path"].ToString();
                        fieldModel.nama_auditor = dr["nama_auditor"].ToString();
                        fieldModel.jenis_audit_id = dr["jenis_audit_id"].ToString();
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    foreach (DataRow dr in data.Rows)
                    {
                        ...
                        fieldModel.psa_id = dr["psa_id"].ToString();
                        fieldModel.psa_id_text = dr["psa_id_text"].ToString();
                        fieldModel.tgl_audit = dr["tgl_audit"].ToString() != "" ? String.Format("{0:yyyy-MM-dd}", dr["tgl_audit"]) : "";
                        fieldModel.dt_tgl_audit = dr["tgl_audit"].ToString() != "" ? String.Format("{0:dd/MM/yyyy}", dr["tgl_audit"]) : "";
                        fieldModel.pelaksana_audit_id = dr["pelaksana_audit_id"].ToString();
                        fieldModel.pelaksana_audit_id_text = dr["pelaksana_audit_id_text"].ToString();
                        string[] init_audit_file_path = FileHelper.GetinitialFiles(_hostingEnvironment, HttpContext, _table_name, "audit_file_path", PkValue, dr["audit_file_path"].ToString());
                        fieldModel.audit_file_path = init_audit_file_path[0];
                        fieldModel.audit_file_path_init = init_audit_file_path[1];
                        fieldModel.nama_auditor = dr["nama_auditor"].ToString();
                        fieldModel.jenis_audit_id = dr["jenis_audit_id"].ToString();
                        fieldModel.jenis_audit_id_text = dr["jenis_audit_id_text"].ToString();
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Insert(AuditModel.ViewModel fieldModel)
        {
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_add))
                {
                    ...
                    data["id"] = AuditModel.GetNewId().ToString();
                    ...
                    data["tgl_audit"] = fieldModel.tgl_audit;
                    data["pelaksana_audit_id"] = fieldModel.pelaksana_audit_id;
                    data["audit_file_path"] = AntiXss.HtmlEncode(fieldModel.audit_file_path);
                    data["nama_auditor"] = AntiXss.HtmlEncode(fieldModel.nama_auditor);
                    data["jenis_audit_id"] = fieldModel.jenis_audit_id;
                    data["masa_berlaku"] = fieldModel.masa_berlaku;
                    data["badan_pemberi_sertifikat"] = AntiXss.HtmlEncode(fieldModel.badan_pemberi_sertifikat);
                    ...
                    result = AuditModel.Insert(_hostingEnvironment, HttpContext, data);
                    return Json(result);
                }
                else
                {
        ...
        [HttpPost]
		[Obsolete]
        public JsonResult Update(AuditModel.ViewModel fieldModel)
        {
            ProsesResult result = new ProsesResult();
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_edit))
                {
                    ...
                    var PkValue = new OrderedDictionary();
                    PkValue["id"] = id_old;
                    OrderedDictionary data_old = DataModel.DtToDictionary(AuditModel.GetData(PkValue));
                    data_old["tgl_audit"] = data_old["tgl_audit"].ToString() != "" ? String.Format("{0:yyyy-MM-dd}", data_old["tgl_audit"]) : "";
                    data_old["masa_berlaku"] = data_old["masa_berlaku"].ToString() != "" ? String.Format("{0:yyyy-MM-dd}", data_old["masa_berlaku"]) : "";
                    OrderedDictionary data = DataModel.DtToDictionary(AuditModel.GetData(PkValue));
                    ...
                    if (DataModel.HasUpdate(data, data_old))
                    {
                        ...
                        result = AuditModel.Update(_hostingEnvironment, HttpContext, data, data_old);
                    }
                    else
                    {
                        result.status = 2;
            ...
            if (SecurityHelper.onPageInit(HttpContext))
            {
                if (SecurityHelper.HasRule(HttpContext, _rule_delete))
                {
                    ...
                    if (jml == 0) {
						...
						if (data != null)
						{
							result = AuditModel.Delete(_hostingEnvironment, HttpContext, data);
							return Json(result);
						}
						else
						{
        ...
        {
            DataTable data = AuditModel.LookupData(param);
            return Json(data);
        }
        public async Task<IActionResult> save_audit_file_path(IEnumerable<IFormFile> audit_file_path_file)
        {
            ...
            string pathData = Path.Combine(upload_temp, sessid); pathData = Path.Combine(pathData, _table_name); pathData = Path.Combine(pathData, "audit_file_path");
            if (audit_file_path_file != null)
            {
                foreach (var file in audit_file_path_file)
                {
        ...
        public ActionResult remove_audit_file_path(string[] fileNames)
        {
            string upload_temp = Settings.GetAppSetting("path_upload_temp") != null ? Settings.GetAppSetting("path_upload_temp") : "C:\\Temp";
            string sessid = HttpContext.Session.Id;
            string pathData = Path.Combine(upload_temp, sessid); pathData = Path.Combine(pathData, _table_name); pathData = Path.Combine(pathData, "audit_file_path");
